            ...
            <section class="vbox">
                <section class="scrollable padder">
                    ...
                    <section class="row m-b-md">
                        <div class="col-sm-6">
                            <h3 class="m-b-xs text-black">Settings</h3> <small>Welcome back, <?php echo $_SESSION['name']; ?>, <i class="fa fa-map-marker fa-lg text-primary"></i><?php echo $_SESSION['email']; ?></small>
                        </div>
                                ...
                                <form class="bs-example form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button name="change_pass" type="submit" class="btn btn-sm btn-default">Change Password</button>
                                        </div>
                                    </div>
